-- Phase 1: Critical Role Security Fixes (Fixed Version)
...
-- Create role validation function (Fixed)
...
-- Update the profiles RLS policy to prevent unauthorized role changes
